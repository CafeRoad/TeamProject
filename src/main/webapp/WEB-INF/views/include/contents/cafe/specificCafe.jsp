...
<table id="cell">
	...
	<tr>
		...
		<td>행사여부: <c:if test="${thisCafe.isEvent() }">행사중이예요</c:if> <c:if
				test="${!thisCafe.isEvent() }">행사중이 아니예요</c:if></td>
	</tr>
</table>
<table>
	<tr>
...
<table>
	<tr>
		<td width="80%"><font size="5" color="ed7d31">리뷰 평점:</font></td>



		<td width="20%"><font size="3">작성자</font></td>
	</tr>
</table>
<table>
	<tr>
		<td width="25%"><font size="4">맛<img
				src="${pageContext.request.contextPath}/resources/assets/cafeimg/star.png"
				width="20px" height="20px" /></font></td>
		<td width="25%"><font size="4">청결<img
				src="${pageContext.request.contextPath}/resources/assets/cafeimg/star.png"
				width="20px" height="20px" /></font></td>
		<td width="25%"><font size="4">서비스<img
				src="${pageContext.request.contextPath}/resources/assets/cafeimg/star.png"
				width="20px" height="20px" /></font></td>
		<td width="25%"><font size="4">분위기<img
				src="${pageContext.request.contextPath}/resources/assets/cafeimg/star.png"
				width="20px" height="20px" /></font></td>
	</tr>
...
<div class="box">
	<div class="content">더보고싶어?더보고싶어?더보고싶어?더보고싶어?더보고싶어?
		더보고싶어?더보고싶어?더보고싶어?더보고싶어? 더보고싶어?더보고싶어?더보고싶어?더보고싶어싫어 보지마 보지말라고 뭘봐 변태새기야</div>
</div>
...
// 주소로 좌표를 검색합니다
geocoder.addressSearch('서울 중구 삼일대로12길 16-6', function(result, status) {
    ...
    // 정상적으로 검색이 완료됐으면 
     ...
     // 인포윈도우로 장소에 대한 설명을 표시합니다
        var infowindow = new kakao.maps.InfoWindow({
            content: '<div style="width:150px;text-align:center;padding:6px 0;">커피한약방</div>'
        });
