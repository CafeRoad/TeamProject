...
<sf:form method="get" action="/cafe/notice/noticeRead">
	...
	<br>
	<br>
<b><center><font size="6" color="gray">공지 사항</font></center></b>


	<div class="price-guest">
		<div class="price-guest-title">${noticeread.getNotice_name()}</div>
		<div class="price-guest-info">${noticeread.getContent()}</div>
