...
public interface CafeMapper {
	...
	final String SELECT_WAITING_CAFE_BY_OWNER_ID = "select * from waiting_cafe natural join waiting_cafe_option where owner_id = #{owner_id}";
	
	@Select(SELECT_WAITING_CAFE_BY_OWNER_ID)
	...
	CafeVO selectWaitingCafeByOwnerId(@Param("owner_id") String owner_id);
